...
commute_df.to_csv(base_folder+ "berlin_output/agent_locations_no2_v2.csv", index=False)

# Take a random sample every 10 rows
commute_samples_df = commute_df.sample(n=1000, random_state=42)
commute_samples_df.to_csv(base_folder+ "berlin_output/agent_locations_no2_v2_subset.csv", index=False)
print("... all finished")